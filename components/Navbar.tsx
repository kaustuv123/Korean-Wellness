...
export function Navbar() {
  ...
  const products = [
    { id: 1, name: "Product 1", image: "/image/download.jpeg" },
    { id: 2, name: "Product 2", image: "/image/download.jpeg" },
    { id: 3, name: "Product 3", image: "/image/download.jpeg" },
    { id: 4, name: "Product 4", image: "/image/download.jpeg" },
    { id: 5, name: "Product 5", image: "/image/download.jpeg" },
  ];
    ...
    <nav className="relative">
      <div className="flex justify-around items-center p-4 sm:p-6">
        ...
        <div className="hidden md:flex flex-row items-center gap-6">
          {!user ? (
            <button className="bg-eggPlant text-white py-2 px-6 sm:px-10 text-[18px] rounded-full hover:bg-black transition-colors">
              Login
            </button>
          ) : (
      ...
      <div className="md:hidden">
        ...
        >
          ...
          <ul className="px-4 py-2">
            ...
            <li className="py-2 border-b hover:text-gray-600 transition-colors">Products</li>
